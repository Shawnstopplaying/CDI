...
filtered_reads <- 
  filterAndTrim(fwd = forward_reads, filt = filtered_forward_reads,
              ...
              trimLeft = c(10, 10), #The first 10 bp had slightly lower quality, but was still >Q30, so it was retained.
              
              # Keep the full forward & trim final 2 bases in the reverse with truncLen
              truncLen = c(220, 130), #The quality score of forward reads drops significantly after 220 bp.The quality of reverse reads starts to drop significantly after 140 bp.
